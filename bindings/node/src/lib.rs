...
/// The `chain` parameter specifies the key's source chain (e.g. "evm", "solana")
/// to determine which curve it uses. Accounts are derived only for chains sharing that curve.
/// Defaults to "evm" (secp256k1) if not specified.
#[napi]
